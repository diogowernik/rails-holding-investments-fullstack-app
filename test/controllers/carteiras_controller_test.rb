...
class CarteirasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carteira" do
    assert_difference('Carteira.count') do
      post carteiras_url, params: { carteira: { nome: @carteira.nome, user_id: @carteira.user_id } }
    end
  ...
  test "should update carteira" do
    patch carteira_url(@carteira), params: { carteira: { nome: @carteira.nome, user_id: @carteira.user_id } }
