class SinteticosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sintetico.save
        format.html { redirect_to @sintetico, notice: 'Sintetico was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sintetico.update(sintetico_params)
        format.html { redirect_to @sintetico, notice: 'Sintetico was successfully updated.' }
