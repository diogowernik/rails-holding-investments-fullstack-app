...
DerivaMove.create(carteira_id: 1, derivativo_id: 1,  estado_id: 3,  valor: 0.23, data: DateTime.strptime('02/09/2020', '%d/%m/%Y'), quantidade:200,  movimento: 'Venda')
DerivaMove.create(carteira_id: 1, derivativo_id: 2,  estado_id: 3,  valor: 0.60, data: DateTime.strptime('02/09/2020', '%d/%m/%Y'), quantidade:200,  movimento: 'Venda')
DerivaMove.create(carteira_id: 1, derivativo_id: 3,  estado_id: 2,  valor: 0.38, data: DateTime.strptime('09/09/2020', '%d/%m/%Y'), quantidade:100,  movimento: 'Venda')
DerivaMove.create(carteira_id: 1, derivativo_id: 4,  estado_id: 2,  valor: 0.40, data: DateTime.strptime('09/09/2020', '%d/%m/%Y'), quantidade:100,  movimento: 'Venda')
DerivaMove.create(carteira_id: 1, derivativo_id: 5,  estado_id: 4,  valor: 0.40, data: DateTime.strptime('22/09/2020', '%d/%m/%Y'), quantidade:100,  movimento: 'Venda')
DerivaMove.create(carteira_id: 1, derivativo_id: 5,  estado_id: 1,  valor: 0.28, data: DateTime.strptime('22/09/2020', '%d/%m/%Y'), quantidade:300,  movimento: 'Venda')
