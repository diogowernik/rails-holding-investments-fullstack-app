...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { description: @tutorial.description, published: @tutorial.published, submitted: @tutorial.submitted, title: @tutorial.title } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { description: @tutorial.description, published: @tutorial.published, submitted: @tutorial.submitted, title: @tutorial.title } }
