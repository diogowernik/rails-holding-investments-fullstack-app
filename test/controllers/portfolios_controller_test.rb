...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { slug: @portfolio.slug, title: @portfolio.title, user_id: @portfolio.user_id } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { slug: @portfolio.slug, title: @portfolio.title, user_id: @portfolio.user_id } }
